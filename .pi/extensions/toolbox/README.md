...
- runs alternate reviewers from GPT-5.6 Sol, GPT-5.5, and GLM-5.2 when available, using `xhigh` for GPT and `max` for GLM, then deduplicates findings and lets you pick what to fix
