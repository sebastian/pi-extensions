import type { AppKeybinding } from "@oh-my-pi/pi-coding-agent";
...
export function getNormalModeInputAction(
	...
	matches: (
		data: string,
		action: "tui.input.submit" | "tui.input.newLine",
	) => boolean,
...
export function normalizeParsedNormalModeKey(
	...
	const candidate = options?.recoveringFromInsertEscape
		? stripAltModifierForEscRecovery(parsedKey)
		: parsedKey;
